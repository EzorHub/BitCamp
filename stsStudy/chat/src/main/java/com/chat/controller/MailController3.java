...
//	private MailSender javaMailSender;
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping("/mailPay.do") public String mailPay() { String str = "";
	 * 
	 * return str; }
	 */
	// 요청
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping("/mail.do") public String mail() { String str = "메일전송완료~!";
	 * List<BitMemberVo> list = bitdao.listAll();
	 * 
	 * SimpleMailMessage mailMessage = new SimpleMailMessage(); for (BitMemberVo m :
	 * list) {
	 * 
	 ...
	 * "UTF-8"); //message.setFrom("bsy62305@naver.com"); //네이버
	 * message.setFrom("zo0313zo@gmail.com"); message.setTo(m.getEmail());
	 ...
	 * 
	 * 
	 * message.addInline("cuties", new
	 * ClassPathResource("com/chat/img/cuties.jpg")); //
